...
public class Hw9 {
    ...
    public static void task1(){
        ...
        System.out.println(res.length() <4? sum + res: res);
   ...
   соответствующее введённому времени (например, ввели 15 часов 6 минут – выводится приветствие «добрый день»)
    */
 ...
 /*Ввести с клавиатуры число. Проверить, что цифры этого числа расположены в неубывающем порядке
  ...
  */
    ...
    public static void task6(){
        ...
        for(int i = 1; i < strNum.length() && isRice; i++){

            isRice = charArr[i] >= charArr[i - 1];
        }

        System.out.print("The number "+ num + (isRice? " is rise": " isn't rise"));

    }

    /*С клавиатуры вводится целое число любой разрядности. Необходимо перевернуть это число,
    ...
    // С клавиатуры вводится целое число. Вывести на экран все числа, на которые введённое число делится без остатка.
